...
<div id="front-page">
  <main id="main">
    ...
    '/images/front-page/resources.jpg'; ?>" alt="Resources Image">
            ...
            <div class="card__content">
              <div>
                ...
                <p>Our factsheets can be found <a href="https://www.health.nsw.gov.au/heal/Pages/default.aspx"
                    target="_blank" rel="noopener noreferrer">here</a>.</p>
              </div>
              <div>
                <h6>Supported Playgroups</h6>
                <p>Resources are available <a href="https://www.health.nsw.gov.au/heal/Pages/default.aspx"
                    target="_blank" rel="noopener noreferrer">here</a>.</p>
              </div>
              <div>
                <h6>Recipes</h6>
                <p>Healthy recepies are available <a href="https://www.heartfoundation.org.au/recipes" target="_blank"
    ...
    '/images/front-page/schools.jpg'; ?>" alt="Resources Image">
            ...
            <div class="card__content">
              <div>
                <p>Information on Live Life Well @ School, Crunch & Sip and Out of School Hours care (OOSH) can be found
                  <a href="https://www.health.nsw.gov.au/heal/primaryschools/Pages/default.aspx" target="_blank"
                    rel="noopener noreferrer">here</a>.</p>
              </div>
              <div>
                <h6>Healthy School Canteens</h6>
                <p>Please visit <a href="https://healthyschoolcanteens.nsw.gov.au/" target="_blank"
                    rel="noopener noreferrer">Healthy School Canteens</a> website for information.</p>
              </div>
            </div>
          </div>
        </div>
    ...
    '/images/front-page/sports.jpg'; ?>" alt="Resources Image">
            ...
            <div class="card__content">
              <div>
                ...
                <p>Find information on Active Kids voucher <a
                    href="https://www.service.nsw.gov.au/transaction/apply-active-kids-voucher" target="_blank"
                    rel="noopener noreferrer">here</a>.</p>
              </div>
            </div>
          </div>
