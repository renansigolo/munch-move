...
if (!function_exists('munch_move_setup')) :
	...
	function munch_move_setup()
	{
		 ...
		 */
		load_theme_textdomain('munch-move', get_template_directory() . '/languages');
		...
		register_nav_menus(array(
			'menu-1' => esc_html__('Primary', 'munch-move'),
		));
		...
		add_theme_support('custom-background', apply_filters('munch_move_custom_background_args', array(
...
function munch_move_scripts()
{
	...
	wp_enqueue_script('munch-move-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true);

	wp_enqueue_script('munch-move-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true);

	wp_enqueue_script('munch-move-footer', get_template_directory_uri() . '/js/footer.js', array(), '20151215', true);
