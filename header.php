		...
		<header id="masthead" class="site-header">
			<div class="site-branding">
				...
				if ($munch_move_description || is_customize_preview()) :
					?>
					<p class="site-description"><?php echo $munch_move_description; /* WPCS: xss ok. */ ?></p>
				<?php endif; ?> -->
			</div>

			<!-- <nav id="site-navigation" class="main-navigation">
				<button class="menu-toggle" aria-controls="primary-menu" aria-expanded="false"><?php esc_html_e('Primary Menu', 'munch-move'); ?></button>
				<?php
				wp_nav_menu(array(
