...
?>
    <section class="covid">
        <div class="container">
            ...
            <p class="covid__text">Information on this website may not reflect current public health advice on COVID-19. We recommend you keep up-to-date with official information and advice on COVID-19 on the <a href="https://preview.nsw.gov.au/covid-19" target="_blank">NSW Government website</a>. If you have any concerns about information on this website please contact <a href="mailto:MOH-ClinicalPolicyAndEngagement@health.nsw.gov.au">MOH-ClinicalPolicyAndEngagement@health.nsw.gov.au</a>.</p>
        </div>
    </section>
<?php endif; ?>